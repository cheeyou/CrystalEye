...
import model.customer.exceptions.DuplicateCustomerException;
...
public class UniqueCustomerList implements Iterable<Customer>{
    ...
    /**
     * Replaces the customer (@code target) in the list with (@code editedCusstomer).
